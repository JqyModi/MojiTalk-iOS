...
namespace L2DDefine {
    ...
    extern const csmInt32 AudioQueueBufferCount;
    extern const csmInt32 AudioQueueBufferSampleCount;
    extern const csmUint32 CsmInputBufferSize;
    extern const csmUint32 CsmRingBufferSize;
    extern const csmInt32 Channels;
    extern const csmInt32 SamplesPerSec;
    extern const csmInt32 BitDepth;
}
