...
L2DWavFileHandler::L2DWavFileHandler()
    : _rawData(NULL)
    , _pcmData(NULL)
...
Csm::csmBool L2DWavFileHandler::Update(Csm::csmFloat32 deltaTimeSeconds)
{
...
void L2DWavFileHandler::Start(const Csm::csmString& filePath)
{
    // WAVファイルのロード
...
Csm::csmFloat32 L2DWavFileHandler::GetRms() const
{
    return _lastRms;
}

const L2DWavFileHandler::WavFileInfo& L2DWavFileHandler::GetWavFileInfo() const
{
    return _wavFileInfo;
}

const Csm::csmByte* L2DWavFileHandler::GetRawData() const
{
    return _rawData;
}

Csm::csmUint64 L2DWavFileHandler::GetRawDataSize() const
{
    return _rawDataSize;
}

Csm::csmVector<Csm::csmFloat32> L2DWavFileHandler::GetPcmData() const
{
...
void L2DWavFileHandler::GetPcmDataChannel(Csm::csmFloat32* dst, Csm::csmUint32 useChannel) const
{
    for (Csm::csmUint32 sampleCount = 0; sampleCount < _wavFileInfo._samplesPerChannel; sampleCount++)
    {
...
Csm::csmFloat32 L2DWavFileHandler::NormalizePcmSample(Csm::csmUint32 bitsPerSample, Csm::csmByte* data, Csm::csmUint32 dataSize)
{
    Csm::csmInt32 pcm32;
...
Csm::csmBool L2DWavFileHandler::LoadWavFile(const Csm::csmString& filePath)
{
    Csm::csmBool ret;
    ...
    // ファイルロード
    _byteReader._fileByte = L2DPal::LoadFileAsBytes(filePath.GetRawString(), &(_byteReader._fileSize));
    ...
    // ファイル開放
    L2DPal::ReleaseBytes(_byteReader._fileByte);
...
Csm::csmFloat32 L2DWavFileHandler::GetPcmSample()
{
    Csm::csmInt32 pcm32;
...
void L2DWavFileHandler::ReleasePcmData()
{
    for (Csm::csmUint32 channelCount = 0; channelCount < _wavFileInfo._numberOfChannels; channelCount++)
    {
