...
@interface OpenMTKView()<MTKViewDelegate>
{
    /// 当前帧的时间
...
// live 2d 相关配置model
@property (nonatomic, strong) OpenL2DConfigurationModel *configurationModel;
// 渲染器
...
- (void)loadLive2D {
    ...
    __weak OpenMTKView* weakSelf = self;
