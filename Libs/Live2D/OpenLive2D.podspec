Pod::Spec.new do |s|
  s.name             = 'OpenLive2D'
  s.version          = '0.1.0'
  s.summary          = 'Live2D Cubism SDK for OpenTalk (with MotionSync)'
  s.description      = <<-DESC
                       Local integration of Live2D Cubism SDK, MotionSync and Wrapper.
                       DESC
  s.homepage         = 'https://github.com/example/OpenLive2D'
  ...
  # Headers
  # Expose headers
  s.public_header_files = 'Bridge/L2DCubism.h', 'Bridge/OpenMTKView.h', 'Bridge/OpenL2DConfigurationModel.h'
  ...
  s.user_target_xcconfig = {
    'HEADER_SEARCH_PATHS' => '"${PODS_ROOT}/OpenLive2D/Core/include" "${PODS_ROOT}/OpenLive2D/Framework/src" "${PODS_ROOT}/OpenLive2D/Bridge" "${PODS_ROOT}/OpenLive2D/MotionSync/Framework/src" "${PODS_ROOT}/OpenLive2D/MotionSync/Core/include"',
    'ALWAYS_SEARCH_USER_PATHS' => 'YES'
  }
end
