...
@objc class MOJiL2DFileManager: NSObject {
    ...
    @objc enum L2DModelType: Int, CaseIterable {
        ...
        var modelDirPath: URL? {
            return MOJiL2DFileManager.destinationURL?.appendingPathComponent(fileName)
        }
        ...
        func toConfigurationModel() -> MOJiL2DConfigurationModel {
            let model = MOJiL2DConfigurationModel()
