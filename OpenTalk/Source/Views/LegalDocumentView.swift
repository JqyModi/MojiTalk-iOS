...
使用 OpenTalk 即表示您同意以下条款和条件。

## 1. 接受条款
访问或使用 OpenTalk，即表示您同意受本协议和我们的隐私政策约束。

## 2. 服务说明
OpenTalk 是一款基于 AI 的日语学习助手。服务包括基于聊天的互动、Live2D 角色可视化、翻译和语法分析。
...
## 4. AI 内容免责声明
OpenTalk 使用人工智能生成回复。虽然我们力求准确，但 AI 生成的内容可能包含错误或不准确之处。我们不对基于 AI 输出所做的任何决定承担责任。

## 5. 终止
如果您违反本协议，我们保留暂停或终止您账户的权利。

## 6. 责任限制
OpenTalk 按"原样"提供，不附带任何保证。我们不对因您使用本服务而产生的任何间接或附带损害承担责任。
...
# OpenTalk User Agreement

**Last Updated: February 6, 2026**

By using OpenTalk, you agree to the following terms and conditions.

## 1. Acceptance of Terms
By accessing or using OpenTalk, you agree to be bound by this Agreement and our Privacy Policy.

## 2. Description of Service
OpenTalk is an AI-powered Japanese language learning assistant. The service includes chat-based interaction, Live2D character visualization, translation, and grammar analysis.
...
OpenTalk uses artificial intelligence to generate responses. While we strive for accuracy, AI-generated content may contain errors or inaccuracies. We are not responsible for any decisions made based on AI output.

## 5. Termination
We reserve the right to suspend or terminate your account if you violate this Agreement.

## 6. Limitation of Liability
OpenTalk is provided "as is" without any warranties. We are not liable for any indirect or consequential damages arising from your use of the service.
...
欢迎使用 OpenTalk。我们致力于保护您的隐私。本隐私政策说明了我们在您使用本应用时如何收集、使用和保护您的信息。
            ...
            ZStack {
                ...
                VStack(spacing: 32) {
                    ...
                    VStack(spacing: 8) {
                        ...
                        Button(action: { openMail(subject: "OpenTalk Feedback") }) {
                            Text(supportEmail)
                                .font(DesignSystem.Fonts.body(size: 14))
                                .foregroundColor(DesignSystem.Colors.accent)
                                .underline()
