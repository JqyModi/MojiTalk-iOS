...
- **Message Content**: We process your messages and voice inputs to generate AI responses. This data is handled through our secure AI partner (Alibaba DashScope).
...
## 3. Data Sharing
We do not sell your personal data. Your message content is sent to our AI service provider (Alibaba DashScope) solely for the purpose of generating responses.
